#!/usr/bin/env python3
"""List or extract a directory containing the recovered UNIX V7 dump records.
...
Usage:
    read_dump.py -d RECORDS -l
    read_dump.py -d RECORDS -x DESTDIR
    read_dump.py -d RECORDS -l --out FILE.out
"""
